...
namespace HAFD.Services
{
    ...
    {
        Task<ResponseManager> RegisterUserAsync(RegisterUserViewModel model, User user, bool isAdmin = false);
    ...
    public class UserServices : IUserServices
    {
        ...
        public UserServices(UserManager<User> userManager, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, DatabaseContext context)
        {
		...
		//REGISTER
		public async Task<ResponseManager> RegisterUserAsync(RegisterUserViewModel model, User user, bool isAdmin = false)
		{
			if (model == null)
