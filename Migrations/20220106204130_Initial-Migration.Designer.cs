...
namespace HAFD.Migrations
{
    ...
    [Migration("20220106204130_Initial-Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HAFD.Models.Hostel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HAFD.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HAFD.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HAFD.Models.Hostel", b =>
                {
                    b.HasOne("HAFD.Models.User", "Occupant")
                        .WithMany()
